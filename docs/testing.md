...
| Idle-retirement TDD gate | `npm run test:idle-retirement` | Paused-clock ACP regressions for refused-close retries, resume/fork idle intervals, late retired-session updates, and recovery guards; see the [Red/Green contract](bridge-state-machine-tdd.md#idle-retirement-regression-gate) |
